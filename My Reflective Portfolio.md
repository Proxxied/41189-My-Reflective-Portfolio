...
During the first week of this subject, I have been introduced into the world of systems, most specifically the human orientated, complex systems. I have learnt that complex systems behave in varying ways, due to the key attributes, boundaries, and characteristics of each system.

### What do I 'now know' that I did not before?

The fact that each complex system possesses key attributes which dictate the elements, relationships, and function of a system. Essentially, a system is more detailed and complex than I originally thought, most notably the differences between a complex, complicated, chaotic, and obvious system. And how there are varying levels and measurements of complexity for a particular system.

### What insights have I gained?

That each system possesses their unique attributes and characteristics leading to the differing measurements in complexity, which in turn dictates the overall outcome and output of a system.
...
As mentioned previously, examples and theories found within the lecture futher assist in my learning. One theory is that systems, complicated and complex do not mean the same thing, rather four different categories to which systems adbide by: complex, complicated, chaotic, and obvious.  
